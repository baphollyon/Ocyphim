...
let sheetPage = (id, pageName) => {
    return `https://docs.google.com/spreadsheets/d/${1P43fbVE88aWGqFtIdJpiX7uvHOTnAedamHWBdfgTrzc}/gviz/tq?tqx=out:json&headers=1&tq=WHERE A IS NOT NULL&sheet=${Ocydex}`
};
